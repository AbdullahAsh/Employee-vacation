<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emp_Leave.aspx.cs" Inherits="Vacation.Emp_Leave" %>
   ...
   <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToCompare="TextBox4" ControlToValidate="TextBox5" CultureInvariantValues="True" Display="Dynamic" ErrorMessage="*Error" Operator="GreaterThan" SetFocusOnError="True" Type="Date">*Error</asp:CompareValidator>
        ...
        <p>
            <asp:Button ID="Button1" runat="server" BackColor="Silver" BorderColor="Black" BorderStyle="Outset" Height="39px" Text="Submit Form" Width="86px"  OnClick="Button1_Click"/>
        </p>
    </form>
</body>
</html>
